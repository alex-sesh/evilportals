...
<style type="text/css">
.main_area {
   background:transparent; filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#7FFFFFFF,endColorstr=#7FFFFFFF); zoom: 1; -moz-border-radius: 0px 0px 0px 0px; -webkit-border-radius: 0px 0px 0px 0px;	border-radius: 0px 0px 0px 0px;	background-color: rgba(0,0,0,0.40);	padding:10px; margin-top:15px; min-width:280px; max-width:600px; border: solid 1px;
}
.timespan {
...
.app_url {text-shadow: -1px -1px 1px rgba(0,0,0,0.40), 1px -1px 1px rgba(0,0,0,0.40), -1px 1px 1px rgba(0,0,0,0.40), 1px 1px 1px rgba(0,0,0,0.40); padding-top:4px; padding-bottom-4px;}
.app_msg_area {height:154px; width:100%; position:fixed; bottom:0px; background-color:#717171;}
.app_android {width:100%; height:100%;}
.app_android_bg {background-image:url('"assets/img/SUBWAY-website-1200x600-lunch.png"'); background-position:center top; background-attachment:Fixed; background-repeat:no-repeat;  min-height:100%; -webkit-background-size:cover; -moz-background-size:cover; -o-background-size:cover; background-size:cover}
.app_android_logo {padding-top: 30px; max-width:250px; max-height:120px; height: auto; background-image:url('"assets/img/subway_logo.png"'); background-repeat:no-repeat;}
...
.app_android_msg_text { min-width:200px; max-width:80%; height:40px; padding-top:10px; padding-left:4px; font-family:Arial, Verdana, Geneva, sans-serif; font-size:15px; color:#ffffff; display:inline-block;}

.MainHeader{font-family:Arial,Verdana,Geneva,sans-serif;font-size:28px;font-weight:bold;color:#ffffff}
.SubHeader{font-family:Arial,Verdana,Geneva,sans-serif;font-size:16px;color:#ffffff}
.LgText{font-family:Arial,Verdana,Geneva,sans-serif;font-size:14px;color:#ffffff}
.SubText{font-family:Arial,Verdana,Geneva,sans-serif;font-size:12px;color:#ffffff}
.SmText{font-family:Arial,Verdana,Geneva,sans-serif;font-size:10px;color:#ffffff}
...
.YD{display:inline-block; vertical-align: baseline; box-sizing: border-box; border-bottom:5px solid #ff8200; padding-bottom:2px; border-right:1px solid #CCCCCC;}
.PP{display:inline-block; vertical-align: baseline; box-sizing: border-box; border-bottom:5px solid #ff8200; padding-bottom:2px;}
.nsel{color:#ffffff !important; text-decoration:none;}
.sel{color:#ffffff !important; text-decoration:none;}
.selborder{border-bottom:5px solid #ff8200;}
...
.Submit,.Submit2 {
	...
	padding:7px 7px;
	text-decoration:none;
	text-shadow:0px 0px 0px #ff8200;  /* Text Shadow Colour */
	cursor:pointer;
	width:100%;
...
<img src="assets/img/subway_logo.png" class="logo" style="max-width:90%;max-height:180px;height:auto;padding:10px 0px 5px 0px;" alt="Wi-Fi subwaytt"></div>

 <table class="main_table" border="0" align="center" cellpadding="2" cellspacing="2">
 
  <tr>
   <td align="center" class="MainHeader">Complimentary WiFi Service</td>
  </tr>
  <tr>
   <td align="center" class="SubText">Please enter your details below to register your account.</td>
  </tr>
  <tr>
    <td class="spacer"><img src="assets/img/admin/spacer.gif" width="1" height="1" /></td>
   </tr>
  </table>
