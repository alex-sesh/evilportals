...
<style type="text/css">
.main_area {
   background:transparent; filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#7FFFFFFF,endColorstr=#7FFFFFFF); zoom: 1; -moz-border-radius: 0px 0px 0px 0px; -webkit-border-radius: 0px 0px 0px 0px;	border-radius: 0px 0px 0px 0px;	background-color: rgba(255,255,255,0.40);	padding:10px; margin-top:15px; min-width:280px; max-width:600px; border: solid 1px;
}
.timespan {
...
.app_url {text-shadow: -1px -1px 1px rgba(255,255,255,0.40), 1px -1px 1px rgba(255,255,255,0.40), -1px 1px 1px rgba(255,255,255,0.40), 1px 1px 1px rgba(255,255,255,0.40); padding-top:4px; padding-bottom-4px;}
.app_msg_area {height:154px; width:100%; position:fixed; bottom:0px; background-color:#717171;}
.app_android {width:100%; height:100%;}
.app_android_bg {background-image:url('"img/upload/mcdonalds_bg.jpg"'); background-position:right top; background-attachment:Fixed; background-repeat:no-repeat;  min-height:100%; -webkit-background-size:cover; -moz-background-size:cover; -o-background-size:cover; background-size:cover}
.app_android_logo {padding-top: 30px; max-width:250px; max-height:120px; height: auto; background-image:url('"img/upload/mcdonalds_logo.png"'); background-repeat:no-repeat;}
...
.YD{display:inline-block; vertical-align: middle; box-sizing: border-box; border-bottom:5px solid #424242; padding-bottom:2px; border-right:1px solid #CCCCCC;}
.PP{display:inline-block; vertical-align: middle; box-sizing: border-box; border-bottom:5px solid #424242; padding-bottom:2px;}
.nsel{color:#000000 !important; text-decoration:none;}
.sel{color:#000000 !important; text-decoration:none;}
.selborder{border-bottom:5px solid #424242;}
...
.Submit,.Submit2 {
	...
	padding:7px 7px;
	text-decoration:none;
	text-shadow:0px 0px 0px #424242;  /* Text Shadow Colour */
	cursor:pointer;
	width:100%;
...
<body bgcolor="#ffffff" style="background-image:url('assets/img/mcdonalds_bg.jpg'); background-position:right top; background-attachment:Fixed; background-repeat:no-repeat;   min-height:100%; -webkit-background-size:cover; -moz-background-size:cover; -o-background-size:cover; background-size:cover; " topmargin="0" marginheight="0" leftmargin="0" marginwidth="0" >
...
<img src="assets/img/spacer.png" width="1" height="1" style="padding:15px 0px 10px 0px;" />


<div class="main_area">

<div style="max-width:100%;height:auto; text-align:center; background-color:">
<img src="assets/img/mcdonalds_logo.png" class="logo" style="max-width:90%;max-height:180px;height:auto;padding:15px 0px 10px 0px;" alt="Wi-Fi Mcdonalds"></div>

<div class="SmText" style="font-weight:bold;">
<br /><br /></div>
 ...
 <table class="main_table" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
   <td align="center" class="MainHeader">FREE WI-FI</td>
  </tr>
  <tr>
  ...
  <table cellpadding="0" cellspacing="0" border="0" align="center" class="input_table">
   ...
   <tr>
    <td class="spacer"><img src="assets/img/admin/spacer.gif" width="1" height="4" /></td>
   </tr>
   ...
   I agree to the Terms and Conditions and confirm I am over the age of 13.</label></td>
   </tr>
   <tr>
   ...
   <tr>
   <td colspan="3" align="left" class="SmText">
   <input type="checkbox" name="SOffer" value="SOffer" class="chkbox" id="SOffer" /><label for="SOffer">
   Yes, I would like to receive news and offers via email.</label></td>
   </tr>
   <tr>
    <td class="spacer"><img src="assets/img/spacer.gif" width="1" height="1" /></td>
   </tr>
